    ...
    <header class="bg-white shadow">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <Link href="/" class="-m-1.5 p-1.5">
                    ...
                    <div class="w-12 h-auto">
                        <svg fill="#000000"  viewBox="0 0 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="enable-background:new 0 0 122.88 122.88" xml:space="preserve">
                            <g>
            ...
            <div class="flex lg:gap-x-12">
                <Link :href="route('tournaments.index')" class="text-sm font-semibold leading-6 text-gray-900">Tournaments</Link>
            </div>
        </nav>
    </header>
    <slot></slot>
